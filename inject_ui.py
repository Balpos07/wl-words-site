...
# Finding the end of panel-stories can be tricky. Let's find panel-earnings and insert before it.
panel_manager_html = """
      <!-- CHAPTER MANAGER -->
  ...
  <div class="modal-overlay" id="chapterModal">
    <div class="modal" style="max-width: 800px; width: 90%;">
      ...
      <div class="modal-footer">
        ...
        <button class="btn-save" onclick="saveChapter()">Save & Publish</button>
      </div>
    </div>
  </div>
"""
